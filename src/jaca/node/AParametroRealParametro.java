...
public final class AParametroRealParametro extends PParametro
{
    private TReal _real_;
    private TId _id_;

    public AParametroRealParametro()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParametroRealParametro(
    ...
    {
        ((Analysis) sw).caseAParametroRealParametro(this);
    }
