...
public final class AVazioListaListaExp extends PListaExp
{
    private TVazioNIgnorado _vazioNIgnorado_;

    public AVazioListaListaExp()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVazioListaListaExp(
    ...
    {
        ((Analysis) sw).caseAVazioListaListaExp(this);
    }
