...
public final class ASenaoEstruturaSenao extends PEstruturaSenao
{
    private TSe _se_;
    ...
    public Object clone()
    {
        return new ASenaoEstruturaSenao(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASenaoEstruturaSenao(this);
    }
