...
public final class AEnquantoComandoSeg extends PComandoSeg
{
    ...
    public Object clone()
    {
        return new AEnquantoComandoSeg(
    ...
    {
        ((Analysis) sw).caseAEnquantoComandoSeg(this);
    }
