...
public final class AChamdaIdComandoAux extends PComandoAux
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AChamdaIdComandoAux(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamdaIdComandoAux(this);
    }
