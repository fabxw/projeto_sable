...
public final class ASenaoComandoFinal extends PComandoFinal
{
    private TSe _se_;
    private TParEsq _parEsq_;
    private PExp _exp_;
    private TParDir _parDir_;
    private PComandoSeg _comandoSeg_;
    private TSenao _senao_;
    private PComando _comando_;

    public ASenaoComandoFinal()
    {
        // Constructor
    }
    ...
    public ASenaoComandoFinal(
        ...
        @SuppressWarnings("hiding") PComandoSeg _comandoSeg_,
    ...
    public Object clone()
    {
        return new ASenaoComandoFinal(
            cloneNode(this._se_),
            cloneNode(this._parEsq_),
            cloneNode(this._exp_),
            cloneNode(this._parDir_),
            cloneNode(this._comandoSeg_),
    ...
    {
        ((Analysis) sw).caseASenaoComandoFinal(this);
    }
    ...
    public PComandoSeg getComandoSeg()
    {
        return this._comandoSeg_;
    }

    public void setComandoSeg(PComandoSeg node)
    {
        if(this._comandoSeg_ != null)
        {
            this._comandoSeg_.parent(null);
        }
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._comandoSeg_ == child)
        {
            this._comandoSeg_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._comandoSeg_ == oldChild)
        {
            setComandoSeg((PComandoSeg) newChild);
            return;
        }
