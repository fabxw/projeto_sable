...
public final class ASeInicialComandoFinal extends PComandoFinal
{
    private TSe _se_;
    ...
    public Object clone()
    {
        return new ASeInicialComandoFinal(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeInicialComandoFinal(this);
    }
