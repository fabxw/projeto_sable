...
public final class AAtribuicaoComandoMedio extends PComandoMedio
{
    private TId _id_;
    ...
    public AAtribuicaoComandoMedio()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAtribuicaoComandoMedio(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAtribuicaoComandoMedio(this);
    }
