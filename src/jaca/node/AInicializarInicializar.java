...
public final class AInicializarInicializar extends PInicializar
{
    private TId _id_;
    private TInicializacao _inicializacao_;
    private PExp _exp_;

    public AInicializarInicializar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AInicializarInicializar(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAInicializarInicializar(this);
    }
