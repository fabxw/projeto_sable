...
public final class AAtribuicaoComandoSeg extends PComandoSeg
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AAtribuicaoComandoSeg(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAtribuicaoComandoSeg(this);
    }
