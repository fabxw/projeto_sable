...
public final class AInicioConstBlocoExp extends PBlocoExp
{
    ...
    public Object clone()
    {
        return new AInicioConstBlocoExp(
    ...
    {
        ((Analysis) sw).caseAInicioConstBlocoExp(this);
    }
