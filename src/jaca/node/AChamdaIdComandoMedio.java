...
public final class AChamdaIdComandoMedio extends PComandoMedio
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AChamdaIdComandoMedio(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamdaIdComandoMedio(this);
    }
