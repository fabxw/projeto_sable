...
public final class AParametroRealParametroSeguinte extends PParametroSeguinte
{
    private TReal _real_;
    private TId _id_;

    public AParametroRealParametroSeguinte()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParametroRealParametroSeguinte(
    ...
    {
        ((Analysis) sw).caseAParametroRealParametroSeguinte(this);
    }
