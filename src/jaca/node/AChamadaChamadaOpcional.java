...
public final class AChamadaChamadaOpcional extends PChamadaOpcional
{
    private TId _id_;
    private TPonto _ponto_;

    public AChamadaChamadaOpcional()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaChamadaOpcional(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamadaChamadaOpcional(this);
    }
