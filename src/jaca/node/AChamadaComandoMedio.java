...
public final class AChamadaComandoMedio extends PComandoMedio
{
    private PChamada _chamada_;
    private TPontoevirgula _pontoevirgula_;

    public AChamadaComandoMedio()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaComandoMedio(
    ...
    {
        ((Analysis) sw).caseAChamadaComandoMedio(this);
    }
