...
public final class ASeInicialComandoSeg extends PComandoSeg
{
    private TSe _se_;
    ...
    public Object clone()
    {
        return new ASeInicialComandoSeg(
            cloneNode(this._se_),
    ...
    {
        ((Analysis) sw).caseASeInicialComandoSeg(this);
    }
