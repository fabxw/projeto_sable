...
public final class AChamdaIdComandoSeg extends PComandoSeg
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AChamdaIdComandoSeg(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAChamdaIdComandoSeg(this);
    }
