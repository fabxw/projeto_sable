...
public final class AEnquantoComandoFinal extends PComandoFinal
{
    ...
    public Object clone()
    {
        return new AEnquantoComandoFinal(
    ...
    {
        ((Analysis) sw).caseAEnquantoComandoFinal(this);
    }
