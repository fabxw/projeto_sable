...
public final class ADecObjSegAtributosSeguintes extends PAtributosSeguintes
{
    private PDecObj _decObj_;
    private PAtributos _atributos_;

    public ADecObjSegAtributosSeguintes()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecObjSegAtributosSeguintes(
    ...
    {
        ((Analysis) sw).caseADecObjSegAtributosSeguintes(this);
    }
