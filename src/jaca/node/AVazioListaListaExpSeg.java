...
public final class AVazioListaListaExpSeg extends PListaExpSeg
{
    private TVazioNIgnorado _vazioNIgnorado_;

    public AVazioListaListaExpSeg()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVazioListaListaExpSeg(
    ...
    {
        ((Analysis) sw).caseAVazioListaListaExpSeg(this);
    }
