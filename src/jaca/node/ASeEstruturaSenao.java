...
public final class ASeEstruturaSenao extends PEstruturaSenao
{
    private TSe _se_;
    ...
    {
        ((Analysis) sw).caseASeEstruturaSenao(this);
    }
