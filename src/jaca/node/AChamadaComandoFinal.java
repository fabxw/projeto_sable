...
public final class AChamadaComandoFinal extends PComandoFinal
{
    private PChamada _chamada_;
    private TPontoevirgula _pontoevirgula_;

    public AChamadaComandoFinal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaComandoFinal(
    ...
    {
        ((Analysis) sw).caseAChamadaComandoFinal(this);
    }
