...
public final class AAtribuicaoComandoAux extends PComandoAux
{
    private TId _id_;
    ...
    public Object clone()
    {
        return new AAtribuicaoComandoAux(
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAAtribuicaoComandoAux(this);
    }
