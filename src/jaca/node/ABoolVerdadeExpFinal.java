...
public final class ABoolVerdadeExpFinal extends PExpFinal
{
    private TVerdade _verdade_;

    public ABoolVerdadeExpFinal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABoolVerdadeExpFinal(
    ...
    {
        ((Analysis) sw).caseABoolVerdadeExpFinal(this);
    }
