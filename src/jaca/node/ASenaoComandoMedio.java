...
public final class ASenaoComandoMedio extends PComandoMedio
{
    private TSe _se_;
    ...
    {
        ((Analysis) sw).caseASenaoComandoMedio(this);
    }
